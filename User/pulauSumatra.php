...
// Ambil data dari tabel 'sumatra'
$query = "SELECT * FROM sumatra";
...
<body>
    ...
    <section class="hero-section hero-sumatra">
        <div class="hero-content">
            <h1>Eksplorasi Pulau Sumatra</h1>
            <p>Temukan keajaiban budaya, sejarah, dan keindahan alam dari destinasi terbaik di Pulau Sumatra.</p>
        </div>
    </section>
    <section class="destination-section">
        <div class="destination-card">
            <img src="/CultureWay/Image/Sumatra Istana Maimun.jpg" alt="Istana Maimun">
            <h3>Istana Maimun</h3>
            <p>Ikon kebanggaan Medan dengan arsitektur khas Melayu yang memukau.</p>
