...
// Ambil data dari tabel 'sulawesi'
$query = "SELECT * FROM sulawesi";
...
<body>
    ...
    <section class="hero-section hero-sulawesi">
        <div class="hero-content">
            <h1>Eksplorasi Pulau Sulawesi</h1>
            <p>Temukan keajaiban budaya, sejarah, dan keindahan alam dari destinasi terbaik di Pulau Sulawesi.</p>
        </div>
    </section>
    
    <section class="destination-section">
        <div class="destination-card">
            <img src="/CultureWay/Image/Sulawesi Benteng Rotterdam.jpg" alt="Benteng Rotterdam">
            <h3>Benteng Rotterdam</h3>
            <p>Bangunan bersejarah peninggalan kolonial Belanda di Makassar.</p>
