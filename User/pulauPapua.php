...
<body>
    ...
    <section class="hero-section hero-papua">
        <div class="hero-content">
            <h1>Eksplorasi Pulau Papua</h1>
            <p>Temukan keajaiban budaya, sejarah, dan keindahan alam dari destinasi terbaik di Pulau Papua.</p>
        </div>
    </section>

    <section class="destination-section">
        <div class="destination-card">
            <img src="/CultureWay/Image/Papua Taman Imbi.jpg" alt="Taman Imbi">
            <h3>Taman Imbi</h3>
            <p>Taman kota yang ikonik di Jayapura, tempat bersantai dan menikmati suasana kota.</p>
            <div class="download-section">
            <a href="pemasanan.php?tujuan=Taman%20Imbi" class="visit-btn">Kunjungi</a>
            </div>
        </div>
        <div class="destination-card">
            <img src="/CultureWay/Image/Papua Danau Sentani.jpeg" alt="Danau Sentani">
            <h3>Danau Sentani</h3>
            <p>Danau indah yang dikelilingi oleh perbukitan hijau, ideal untuk wisata alam dan budaya.</p>
            <a href="#" class="visit-btn">Kunjungi</a>
        </div>
        <div class="destination-card">
            <img src="/CultureWay/Image/Papua Raja Ampat.jpg" alt="Raja Ampat">
            <h3>Raja Ampat</h3>
            <p>Kepulauan eksotis dengan kehidupan bawah laut yang menakjubkan, surga bagi penyelam.</p>
            <a href="#" class="visit-btn">Kunjungi</a>
        </div>
    </section>
