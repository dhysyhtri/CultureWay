...
// Ambil data dari tabel 'bali'
$query = "SELECT * FROM bali";
...
<body>
    ...
    <section class="hero-section hero-bali">
        <div class="hero-content">
            <h1>Eksplorasi Pulau Bali</h1>
            <p>Temukan keajaiban budaya, sejarah, dan keindahan alam dari destinasi terbaik di Pulau Bali.</p>
        </div>
    </section>
    ...
    <section class="destination-section">
        <div class="destination-card">
            <img src="/CultureWay/Image/Bali Pura Ulun Danu Bratan.png" alt="Pura Ulun Danu Bratan">
            <h3>Pura Ulun Danu Bratan</h3>
            <p>Pura indah di tepi Danau Bratan yang menjadi ikon Bali.</p>
            <div class="download-section">
                <a href="pemasanan.php">Kunjungi</a>
            </div>
        </div>
