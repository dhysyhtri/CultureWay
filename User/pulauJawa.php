...
// Ambil data dari tabel 'jawa'
$query = "SELECT * FROM jawa";
...
<body>
    ...
    <section class="hero-section hero-jawa">
        <div class="hero-content">
            <h1>Eksplorasi Pulau Jawa</h1>
            <p>Temukan keajaiban budaya, sejarah, dan keindahan alam dari destinasi terbaik di Pulau Jawa.</p>
        </div>
    </section>
    ...
    <section class="destination-section">
        <div class="destination-card">
            <img src="/CultureWay/Image/Jawa Kraton Jogja.jpeg" alt="Kraton Yogyakarta">
            <h3>Kraton Yogyakarta</h3>
            <p>Ikon budaya Yogyakarta, tempat tinggal Sultan dan pusat tradisi Jawa.</p>
            <div class="download-section">
            <a href="pemasanan.php?tujuan=Kraton%20Yogyakarta" class="visit-btn">Kunjungi</a>
            </div>
        </div>
