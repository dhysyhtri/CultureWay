...
// Ambil semua data Papua
$papua = mysqli_query($conn, "SELECT * FROM papua");

// Hapus data
if (isset($_GET['delete_papua'])) {
    $id = intval($_GET['delete_papua']);
    $query = "DELETE FROM papua WHERE id='$id'";
...
<head>
    ...
    <title>Admin - Data Pulau Papua</title>
...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            <header>
                <h1>Data Pulau Papua</h1>
                <a href="tambah papua.php" class="add-btn">Tambah Data</a>
            </header>
            ...
            <section class="content">
                <table>
                    ...
                    <tbody>
                        <?php $no = 1;
                        while ($data = mysqli_fetch_assoc($papua)) { ?>
                            <tr id="papua-<?= $data['id']; ?>">
                                <td><?= $no++; ?></td>
                                ...
                                <td>
                                    <a href="edit papua.php?edit_papua=<?= $data['id']; ?>"
