...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($edit) {
        $query = "UPDATE bali SET tempat='$tempat', keterangan='$keterangan', gambar='$gambar_upload_path' WHERE id='$id'";
    } else {
        $query = "INSERT INTO bali (tempat, keterangan, gambar) VALUES ('$tempat', '$keterangan', '$gambar_upload_path')";
    }
...
<head>
    ...
    <title><?= $edit ? 'Edit Data Pulau Bali' : 'Tambah Data Pulau Bali' ?></title>
...
<div class="form-container">
    <h1><?= $edit ? 'Edit Data Pulau Bali' : 'Tambah Data Pulau Bali' ?></h1>
    <form method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <?php if ($edit && $data['gambar']): ?>
                <p>Gambar saat ini: <img src="upload/<?= $data['gambar'] ?>" alt="Current image" width="100"></p>
            <?php endif; ?>
        </div>
