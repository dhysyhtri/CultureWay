...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($edit) {
        $query = "UPDATE jawa SET tempat='$tempat', keterangan='$keterangan', gambar='$gambar_upload_path' WHERE id='$id'";
    } else {
        $query = "INSERT INTO jawa (tempat, keterangan, gambar) VALUES ('$tempat', '$keterangan', '$gambar_upload_path')";
    }
...
<head>
    ...
    <title><?= $edit ? 'Edit Data Pulau Jawa' : 'Tambah Data Pulau Jawa' ?></title>
...
<div class="form-container">
    <h1><?= $edit ? 'Edit Data Pulau Jawa' : 'Tambah Data Pulau Jawa' ?></h1>
