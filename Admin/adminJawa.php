...
// Ambil semua data Pulau Jawa
$jawa = mysqli_query($conn, "SELECT * FROM jawa");

// Hapus data
if (isset($_GET['delete_jawa'])) {
    $id = intval($_GET['delete_jawa']);
    $query = "DELETE FROM jawa WHERE id='$id'";
...
<head>
    ...
    <title>Admin - Data Pulau Jawa</title>
...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            <header>
                <h1>Data Pulau Jawa</h1>
                <a href="tambahPulauJawa.php" class="add-btn">Tambah Data</a>
            </header>
            ...
            <section class="content">
                <table>
                    ...
                    <tbody>
                        <?php $no = 1;
                        while ($data = mysqli_fetch_assoc($jawa)) { ?>
                            <tr id="jawa-<?= $data['id']; ?>">
                                <td><?= $no++; ?></td>
                                ...
                                <td>
                                    <a href="adminEditJawa.php?edit_jawa=<?= $data['id']; ?>"
