...
if (isset($_GET['edit_data'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM kalimantan WHERE id='$id'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($edit) {
        $query = "UPDATE kalimantan SET tempat='$tempat', keterangan='$keterangan', gambar='$gambar_upload_path' WHERE id='$id'";
    } else {
        $query = "INSERT INTO kalimantan (tempat, keterangan, gambar) VALUES ('$tempat', '$keterangan', '$gambar_upload_path')";
    }
...
<head>
    ...
    <title><?= $edit ? 'Edit Data Pulau Kalimantan' : 'Tambah Data Pulau Kalimantan' ?></title>
...
<div class="form-container">
    <h1><?= $edit ? 'Edit Data Pulau Kalimantan' : 'Tambah Data Pulau Kalimantan' ?></h1>
