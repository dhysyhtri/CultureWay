...
// Ambil semua data Lombok
$lombok = mysqli_query($conn, "SELECT * FROM lombok");

// Hapus data
if (isset($_GET['delete_lombok'])) {
    $id = intval($_GET['delete_lombok']);
    $query = "DELETE FROM lombok WHERE id='$id'";
...
<head>
    ...
    <title>Admin - Data Pulau Lombok</title>
    ...
    <script>
        function deleteData(id) {
            if (confirm("Yakin ingin menghapus data ini?")) {
                $.ajax({
                    url: "admin lombok.php",
                    type: "GET",
                    data: { delete_lombok: id },
...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            <header>
                <h1>Data Pulau Lombok</h1>
                <a href="tambah lombok.php" class="add-btn">Tambah Data</a>
            </header>
            ...
            <section class="content">
                <table>
                    ...
                    <tbody>
                        <?php $no = 1;
                        while ($data = mysqli_fetch_assoc($lombok)) { ?>
                            <tr id="lombok-<?= $data['id']; ?>">
                                <td><?= $no++; ?></td>
                                ...
                                <td>
                                    <a href="edit lombok.php?edit_lombok=<?= $data['id']; ?>"
