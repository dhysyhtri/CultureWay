...
if (isset($_GET['edit_data'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM sumatra WHERE id='$id'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($edit) {
        $query = "UPDATE sumatra SET tempat='$tempat', keterangan='$keterangan', gambar='$gambar_upload_path' WHERE id='$id'";
    } else {
        $query = "INSERT INTO sumatra (tempat, keterangan, gambar) VALUES ('$tempat', '$keterangan', '$gambar_upload_path')";
    }
...
<head>
    ...
    <title><?= $edit ? 'Edit Data Pulau Sumatra' : 'Tambah Data Pulau Sumatra' ?></title>
...
<div class="form-container">
    <h1><?= $edit ? 'Edit Data Pulau Sumatra' : 'Tambah Data Pulau Sumatra' ?></h1>
