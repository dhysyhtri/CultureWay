...
// Ambil semua data Sulawesi
$sulawesi = mysqli_query($conn, "SELECT * FROM sulawesi");

// Hapus data
if (isset($_GET['delete_sulawesi'])) {
    $id = intval($_GET['delete_sulawesi']);
    $query = "DELETE FROM sulawesi WHERE id='$id'";
...
<head>
    ...
    <title>Admin - Data Pulau Sulawesi</title>
    ...
    <script>
        function deleteData(id) {
            if (confirm("Yakin ingin menghapus data ini?")) {
                $.ajax({
                    url: "admin sulawesi.php",
                    type: "GET",
                    data: { delete_sulawesi: id },
...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            <header>
                <h1>Data Pulau Sulawesi</h1>
                <a href="tambah sulawesi.php" class="add-btn">Tambah Data</a>
            </header>
            ...
            <section class="content">
                <table>
                    ...
                    <tbody>
                        <?php $no = 1;
                        while ($data = mysqli_fetch_assoc($sulawesi)) { ?>
                            <tr id="sulawesi-<?= $data['id']; ?>">
                                <td><?= $no++; ?></td>
                                ...
                                <td>
                                    <a href="edit sulawesi.php?edit_sulawesi=<?= $data['id']; ?>"
