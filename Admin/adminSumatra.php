...
// Ambil semua data Pulau Sumatra
$sumatra = mysqli_query($conn, "SELECT * FROM sumatra");

// Hapus data
if (isset($_GET['delete_sumatra'])) {
    $id = intval($_GET['delete_sumatra']);
    $query = "DELETE FROM sumatra WHERE id='$id'";
...
<head>
    ...
    <title>Admin - Data Pulau Sumatra</title>
    ...
    <script>
        function deleteData(id) {
            if (confirm("Yakin ingin menghapus data ini?")) {
                $.ajax({
                    url: "admin sumatra.php",
                    type: "GET",
                    data: { delete_sumatra: id },
...
<body>
    <div class="admin-container">
        ...
        <main class="main-content">
            <header>
                <h1>Data Pulau Sumatra</h1>
                <a href="tambah sumatra.php" class="add-btn">Tambah Data</a>
            </header>
            ...
            <section class="content">
                <table>
                    ...
                    <tbody>
                        <?php $no = 1;
                        while ($data = mysqli_fetch_assoc($sumatra)) { ?>
                            <tr id="sumatra-<?= $data['id']; ?>">
                                <td><?= $no++; ?></td>
                                ...
                                <td>
                                    <a href="edit sumatra.php?edit_sumatra=<?= $data['id']; ?>"
